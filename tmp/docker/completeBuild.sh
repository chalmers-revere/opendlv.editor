...
# completeBuild.sh - Script to build opendlv.sim
...
echo "[Docker builder] Complete build of opendlv.sim."
cmake -E remove_directory .
CCACHE_DIR=/opt/ccache PATH=/usr/lib/ccache:/opt/od4/bin:$PATH cmake -D CXXTEST_INCLUDE_DIR=/opt/opendlv.sim.sources/thirdparty/cxxtest -D OPENDAVINCI_DIR=/opt/od4 -D PACKAGING_ENABLED=$PACKAGING_ENABLED -D ODVDOPENDLVSTANDARDMESSAGESET_DIR=/opt/opendlv.core -D CMAKE_INSTALL_PREFIX=/opt/opendlv.sim /opt/opendlv.sim.sources
